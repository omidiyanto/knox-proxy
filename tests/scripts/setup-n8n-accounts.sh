...
N8N_URL="${N8N_URL:-http://${HOST_IP:-127.0.0.1}:5678}"
OWNER_EMAIL="owner@knox-ci.local"
OWNER_PASSWORD="ownerPass123"
OWNER_FIRST="CI"
OWNER_LAST="Owner"
TEAM_EMAIL="${TEAM_EMAIL:-test@knox-ci.local}"
...
KNOX_TEST_BASE_URL=http://${HOST_IP:-127.0.0.1}:8443
KEYCLOAK_URL=http://${HOST_IP:-127.0.0.1}:8080
N8N_URL=http://${HOST_IP:-127.0.0.1}:5678
VAULT_ADDR=http://${HOST_IP:-127.0.0.1}:8200
